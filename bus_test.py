...
class Tests(unittest.TestCase):
    ...
    def test_xx(self):
        ...
        self.assertEqual(departs, [['2017-11-03 15:52:32','2017-11-03 15:52:32'], ['2017-11-03 15:53:02'], [], []])
    ...
    def test_xxx(self):
        ...
        arrives, departs = bus.extract_time(lines, 3)
        self.assertEqual(arrives, [[], ['2017-11-03 15:52:47', '2017-11-03 15:53:02'], [], []])
        self.assertEqual(departs, [['2017-11-03 15:52:32','2017-11-03 15:52:32','2017-11-03 15:52:32'], ['2017-11-03 15:53:02'], [], []])
    ...
    def test_xx2(self):
        ...
        arrives, departs = bus.extract_time(lines, 3)
        self.assertEqual(arrives, [[], ['2017-11-03 15:52:47', '2017-11-03 15:53:02'], [], []])
        self.assertEqual(departs, [['2017-11-03 15:52:32','2017-11-03 15:52:32'], ['2017-11-03 15:53:17','2017-11-03 15:53:32'], [], []])
#有两辆车的时候 程序运行只有一个depart时间
