...
class Tests(unittest.TestCase):
    ...
    def test_newbbug(self):
        ...
        #可能是由于隧道等原因导致信号传输问题，发生突变，目前我预想这个结果应该假设t1时刻已经到达第三站，并停留0秒，且出发前往第四站，在下一时刻到来刚好到达第四站?
        #第二种方法是由离开第二站的时刻t2到出现突变时刻t1，中间时间差为2-3站与3-4站时间之和，将其等分于ptime[2]和ptime[3]
        ptime, stime = bus.extract_time_all(lines, 5)
        self.assertEqual(ptime, [[], [19], [10], [], []])
        self.assertEqual(stime, [[], [], [0], [34], []])
